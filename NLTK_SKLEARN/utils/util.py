...
def tokenize(tags):
    """ performs word and sentence tokeniziation
...
def calculatePercentageOfEntities(filepath):
    ...
    AmountOfEntities = {"B-person":0, "B-location":0, "B-corporation":0, "B-product":0, "B-creative-work":0, "B-group":0, "O":0}
    percentageOfEntities = {"B-person":0, "B-location":0, "B-corporation":0, "B-product":0, "B-creative-work":0, "B-group":0, "O":0}
...
if __name__ == '__main__':
    ...
    testInstances, testPercentages = calculatePercentageOfEntities(r"Data\wnut\emerging.test.annotated")
    print(testInstances)
